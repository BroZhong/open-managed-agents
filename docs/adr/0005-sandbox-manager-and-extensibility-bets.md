...
**Partially superseded by [ADR-0007](0007-oss-mounted-workspaces.md).** Workspace root, hydrate/sync/Baseline, checkpoint and file-change event decisions in sections 1–3 and 5 are superseded by ADR-0007. Sandbox Manager ownership, Tool-mode boundaries and Skills Read-only Projections remain accepted. The original decision below records history, not the current storage contract.
