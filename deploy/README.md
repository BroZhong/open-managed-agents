...
| Agent sandboxes | `sandbox-system` | ACK sandbox manager/gateway; `auto-story-v2` SandboxSet |
...
its versioned release tag; see [sandbox/auto-story-v2/README.md](sandbox/auto-story-v2/README.md)
...
The build and deploy commands above target `auto-story-v2`.
